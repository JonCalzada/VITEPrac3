...
private:
	...
	void buildVertices(float size) {
		for (int theta = 0; theta < 360; theta += 5) {
			...
			v.Position.z = -size;
			if (theta == 0) { v.Color.r = 0.76f; v.Color.g = 0.57f; v.Color.b = 0.15f; }
			if (theta == 120) { v.Color.r = 0.76f; v.Color.g = 0.57f; v.Color.b = 0.15f; }
			if (theta == 240) { v.Color.r = 0.76f; v.Color.g = 0.57f; v.Color.b = 0.15f; }
			v.Color.a = 1.0f;
	...
	void buildIndices() {
		...
		indices.push_back(numVertices2 - 1); indices.push_back(2 * numVertices2 - 1); indices.push_back(0);
		...
		indices.push_back(0); indices.push_back(numVertices2); indices.push_back(2 * numVertices2 - 1);
	}
};
