...
private:
	...
	void buildVertices(float size) {
		for (int theta = 0; theta < 360; theta += 5) {
			...
			v.Position.z = 0.0f;
			if (theta == 0) { v.Color.r = 0.0f; v.Color.g = 0.0f; v.Color.b = 0.0f; }
			if (theta == 120) { v.Color.r = 0.0f; v.Color.g = 0.0f; v.Color.b = 0.0f; }
			if (theta == 240) { v.Color.r = 0.0f; v.Color.g = 0.0f; v.Color.b = 0.0f; }
			v.Color.a = 1.0f;
