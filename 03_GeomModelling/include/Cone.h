...
private:
	...
	void buildVertices(float size) {
		for (int theta = 0; theta < 360; theta += 5) {
			...
			v.Position.z = -size;
			if (theta == 0) { v.Color.r = 0.10f; v.Color.g = 2.13f; v.Color.b = 0.37f; }
			if (theta == 120) { v.Color.r = 0.10f; v.Color.g = 2.13f; v.Color.b = 0.37f; }
			if (theta == 240) { v.Color.r = 0.10f; v.Color.g = 2.13f; v.Color.b = 0.37f; }
			v.Color.a = 1.0f;
		...
		for (int theta = 0; theta < 360; theta += 5) {
			...
			v.Position.y = 0.0F;
			v.Position.z = size;
			if (theta == 0) { v.Color.r = 2.55f; v.Color.g = 2.55f; v.Color.b = 2.55f; }
			if (theta == 120) { v.Color.r = 2.55f; v.Color.g = 2.55f; v.Color.b = 2.55f; }
			if (theta == 240) { v.Color.r = 2.55f; v.Color.g = 2.55f; v.Color.b = 2.55f; }
			v.Color.a = 1.0f;
			vertices.push_back(v);
		}
	}
